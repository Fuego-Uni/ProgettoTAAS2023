...
export let rating_personal: number = 0;
export let rating_average: number = 0;
...
<style lang="scss">
  .rating {
    ...
    .empty {
      fill: var(--color-ui-text-unfocused);
    }
