...
export const getFilmInfo = async (id: string): Promise<MediaData> => {
...
export const getAllFilms = async (page: number): Promise<MediaData[]> => {
...
export const getAllFilmReview = async (id: string): Promise<Review[]> => {
